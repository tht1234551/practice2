...
public class StringConvertUtil {
	...
	private static final Logger logger = LoggerFactory.getLogger(StringConvertUtil.class);
     ...
     * @return
     */
    public static String getHashValue(String str) throws NoSuchAlgorithmException {
    	MessageDigest md5 = MessageDigest.getInstance("MD5");

    	logger.debug("getAlgorithm ::::" + md5.getAlgorithm());
